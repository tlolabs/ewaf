...
static void activate(GtkApplication *app,gpointer data) {
    ...
    g_signal_connect(w->start,"changed",G_CALLBACK(changed),w); g_signal_connect(w->end,"changed",G_CALLBACK(changed),w); g_signal_connect(w->weekday,"notify::selected",G_CALLBACK(weekday_changed),w); g_signal_connect(w->search,"search-changed",G_CALLBACK(changed),w);

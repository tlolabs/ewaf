...
icon_ref=add('icon', 'PBXFileReference', lastKnownFileType='image.icns', path='../../assets/icon/ewaf.icns', sourceTree='<group>')
...
app_settings=dict(settings, INFOPLIST_KEY_CFBundleIconFile='ewaf.icns', PRODUCT_NAME='EWAF', PRODUCT_BUNDLE_IDENTIFIER='com.tlolabs.ewaf', INFOPLIST_KEY_CFBundleDisplayName='EWAF')

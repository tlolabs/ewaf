...
app_sources=source_phase('app', sorted((root/'Sources/EWAF').rglob('*.swift')))
test_sources=source_phase('test', sorted((root/'tests/EWAFUITests').glob('*.swift')))
...
settings=dict(SWIFT_VERSION='6.0', MACOSX_DEPLOYMENT_TARGET='14.0', SDKROOT='macosx', CODE_SIGNING_ALLOWED='YES', CODE_SIGN_IDENTITY='-', CODE_SIGN_STYLE='Manual', GENERATE_INFOPLIST_FILE='YES', CURRENT_PROJECT_VERSION='1', MARKETING_VERSION='1.0.0', PRODUCT_NAME='$(TARGET_NAME)', ENABLE_HARDENED_RUNTIME='YES')
